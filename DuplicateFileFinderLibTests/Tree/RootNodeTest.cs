...
public class RootNodeTests
{
    ...
    {
        var root = new RootNode();
        var a = new FolderNode(PathUtil.P("/", "R", "A"));
        var b = new FolderNode(PathUtil.P("/", "R", "B"));
    
        a.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "A", "x.txt"), 1));
        b.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "B", "y.txt"), 2));
    ...
    public async Task Root_MultipleLevels_ProducesExpectedCountsAndBytes()
    {
        ...
        var a  = new FolderNode(PathUtil.P("/", "R", "A"));
        var a1 = new FolderNode(PathUtil.P("/", "R", "A", "A1"));
        var b  = new FolderNode(PathUtil.P("/", "R", "B"));
    
        a.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "A", "fa.bin"), 10));
        a1.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "A", "A1", "fa1.bin"), 20));
        a.AddFileSystemNode(a1);
    
        b.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "B", "fb.bin"), 30));
    ...
    public async Task Root_SingleTopFolder_WorksAsExpected()
    {
        ...
        a.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "A", "x.bin"), 5));
        root.AddFileSystemNode(a);
    ...
    public async Task Root_Recompute_MatchesManualPostOrderAcrossChildren()
    {
        ...
        var a = new FolderNode(PathUtil.P("/", "R", "A"));
        var b = new FolderNode(PathUtil.P("/", "R", "B"));
        var c = new FolderNode(PathUtil.P("/", "R", "C"));
    
        a.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "A", "a.bin"), 1));
        b.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "B", "b.bin"), 2));
        c.AddFileSystemNode(new FileNode(PathUtil.P("/", "R", "C", "c.bin"), 3));
