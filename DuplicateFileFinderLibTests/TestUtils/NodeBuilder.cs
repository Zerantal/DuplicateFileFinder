...
public sealed class FileNodeBuilder
{
    ...
    public FileNodeBuilder Modified(DateTimeOffset t) { _modified = t; return this; }
    ...
    {
        var n = new FileNode(_path, _size, _created, _modified);
...
public sealed class FolderNodeBuilder(
    string path,
    DateTimeOffset created = default,
    DateTimeOffset modified = default)
{
    private readonly FolderNode _folder = new(path, created, modified);
